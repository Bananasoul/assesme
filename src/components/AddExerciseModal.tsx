...
export default function AddExerciseModal({ recordId, patientId }: Props) {
            ...
            <form ref={formRef} onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
              ...
              <div>
                ...
                <input 
                  ...
                  name="name" 
                  required
                  placeholder="Ex: Fente avant, Squat..."
              ...
              <div>
                ...
                <textarea 
                  name="instructions" 
                  rows={3}
                  placeholder="Ex: Garder le dos bien droit, respirer profondément..."
                  style={{ width: '100%', padding: '0.75rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--border)', background: 'var(--background)' }}
                />
              </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '1rem', marginTop: '1rem' }}>
                <button 
                  type="button" 
                  onClick={() => setIsOpen(false)}
                  style={{ padding: '0.75rem 1.5rem', fontWeight: 600, color: 'var(--text-secondary)' }}
                >
                  Annuler
                </button>
                <button 
